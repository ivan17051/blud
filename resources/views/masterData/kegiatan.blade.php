        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nama" name="nama" class="form-control" placeholder="Nama Kegiatan" required>
                </div>
            </div>
...
<div class="modal modal-danger fade" id="sunting" tabindex="-1" role="dialog" aria-labelledby="Sunting Rekanan" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="suntingLabel">Sunting Kegiatan</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" name="kode" class="form-control" placeholder="Kode Kegiatan" required>
                </div>
                <div class="form-group">
                    <label><b>Nama</b></label>
...
<!-- Hapus -->
<form hidden action="{{route('kegiatan.delete')}}" method="POST" id="delete">
    @csrf
    @method('delete')
    <input type="hidden" name="id">
</form>
...
<script>
    ...
    $modal.find('input[name=nama]').val(data['Nama Kegiatan']);
}
