...
## ubahRek
Melakukan perubahan pada data rekening(menambah atau menghapus).

#### Parameters
[idtransaksi](https://github.com/ivan17051/blud/blob/master/resources/views/transaksi.blade.php)
